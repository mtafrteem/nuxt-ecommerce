                    ...
                    >
                      ...
                      <td class="b-none" width="50%">
                        ...
                        <table class="table-borderless table-font">
                          <tr>
                            <td style="padding: 0.2rem">Jumlah</td>
              ...
              <div class="row mt-4">
                ...
                <div class="col-md-6">
                  <div class="form-group" v-if="courier.showService">
                    <label class="font-weight-bold">Layanan Kurir</label>
                    <br />
                    <div
          ...
          <div class="card border-1 rounded">
            <div class="card-body">
              ...
              <p style="font-size: 15px" class="mb-1">
                Total Harga ( produk)
                <span class="float-right font-weight-bolder" id="subtotal"
                  >Rp{{ formatPrice(cartPrice) }}</span
                >
              </p>
              <p style="font-size: 15px" class="mb-2">
                Total Ongkir ({{ cartWeight }} gram)
                <span class="float-right font-weight-bolder" id="ongkir-cart"
                  >Rp{{ formatPrice(courier.courier_cost) }}</span
                >
              </p>
              <hr />
              <h5 class="mb-1">
              ...
              <p style="font-size: 12px" class="mt-4 mb-n1">
            ...
            <div class="col-md-12" v-if="btnCheckout">
              ...
              >
                <span class="font-weight-bolder"><i class="fa fa-shield-alt"></i> Buat Pesanan</span>
              </button>
            </div>
          </div>
        </div>
...
export default {
  ...
  head() {
    return {
      title: "Cart - Tokobiru | Situs Belanja Online Terpercaya!",
      meta: [
        {
          hid: "og:title",
          name: "og:title",
          content: "Cart - Tokobiru | Situs Belanja Online Terpercaya!",
        },
        {
          hid: "og:site_name",
          name: "og:site_name",
